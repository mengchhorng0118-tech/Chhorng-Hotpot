...
<header>
    <h1>🔥 Hotpot Restaurant Ordering System
        <span id="tableNumber">Table ?</span>

        <!-- <span><button onclick="location.href='kitchen.html'">Kitchen</button></span> -->
    </h1>
</header>
...
<div class="container">
    ...
    <div class="cart">
        ...
        <button href="thankyou.html" class="confirm-btn" onclick="confirmOrder()">Confirm Order</button><br>
        <h1><span>You Want To Order You Can Click Register</span></h1>

<a href="{{ route('entry') }}" class="confirm-btn" style="display:block; text-align:center; text-decoration:none; margin-top:10px;">
Register
</a>
...
let tableNumber = params.get("table") || "Unknown";
